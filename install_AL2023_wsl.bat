...
wsl -d %DISTRONAME% bash -c "dnf -y -q install util-linux passwd sudo which git vim jq tar awscli findutils xz procps-ng net-tools bind-utils nc 'dnf-command(check-release-update)'" 2>NUL
if %ERRORLEVEL% neq 0 (
